...
function Index() {
  ...
  const submitUserData = async (e) => {
    ...
    const { full_name, phone_number, cnic, password, address, store_name, cnic_picture } = inputData
    if (full_name === "") {
      ...
      <div className="container">
        ...
        <div className="row align-items-center mt-5">
          <div className="col-md-6">
            <h2>Sign-Up As <br /> Sahulatgaar Seller</h2>
          ...
          <div className="col-md-6">
            <div className="row">
              <div className="col-md-9 mx-auto">
                ...
                <input type="number" onChange={setInputValue} className='form-control' value={inputData.phone_number} placeholder='Phone Number' name='phone_number' />
